...
**Internal crate** — not a public API. All downstream consumers import via the flat re-export surface in `lib.rs`. **Use the facade API (`AOL2/truth-engine/qssm-api`) instead of depending on this crate directly.**
