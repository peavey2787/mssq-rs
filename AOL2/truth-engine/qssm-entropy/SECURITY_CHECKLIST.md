...
**Scope:** Pure harvesting + to_seed() crate (`AOL2/truth-engine/qssm-entropy`)
...
`qssm-local-prover`, `qssm-api`, `desktop`, `zk-examples`, and `mssq-net`.
...
[x] Application/UI harvest gate — moved to `desktop`. Not this crate's responsibility.
